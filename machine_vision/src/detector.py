...
from machine_vision.msg import BoundingBox, BoundingBoxes
from cv_bridge import CvBridge, CvBridgeError

package = RosPack()
package_path = package.get_path('machine_vision')
...
class DetectorManager():
    def __init__(self):
        ...
        self.pub_viz_ = rospy.Publisher(self.published_image_topic, Image, queue_size=1)
